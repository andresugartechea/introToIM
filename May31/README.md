# Intro to IM | 05/31/2021 : working with "Processing"
...
#### Step 2:
Then, I drew on a piece of paper the path that the piece needs to follow, so I could have an idea of the coordinates of each point. 
...
#### Step 3:
I wanted the user to understand that they need to follow the path. So everytime the piece is not in the line, everything turns white and only the starting points and the red piece appear on screen. For some reason, when you iniciate the game the size of the green and blue boxes change and I couldn't figure out how to change that. 
